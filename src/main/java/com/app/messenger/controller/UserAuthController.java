...
public class UserAuthController {
    ...
    public ResponseDTO<LoginResponseDTO> login(@RequestBody LoginRequestDTO loginRequest) {
        return ResponseDTO.ok(userAuthService.login(loginRequest));
    }

    @PostMapping(value = "/register", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseDTO<Void> register(@RequestBody RegisterRequestDTO registerRequestDTO) {
